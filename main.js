...
function loadTechnologies(technos) {
    fetch('https://us-central1-pwa-technos-8932d.cloudfunctions.net/getTechnos ')
        .then(response => {
            response.json()
                .then(technos => {
...
if (navigator.serviceWorker) {
    navigator.serviceWorker
        ...
        .then(registration => {
            ...
            const publicKey = "BCkFQ35OjpKovHruvoPLaiGe06qjqbVeweGGG7O9jiVUGn9TmxQXcnAe85zO9YXzBhG4iRyxknK9V0FoU3vScXQ";
